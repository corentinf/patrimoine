...
export default function SavingsRateModule({ currentSpending, prevSpending, monthlyIncome, periodDays, pacedTotal }: Props) {
  ...
  return (
    <div className="card flex flex-wrap divide-x divide-sand-200">
      {/* Spending stat */}
      <div className="flex-1 min-w-[140px] pr-6">
        <p className="text-xs font-semibold text-ink-500 uppercase tracking-wider mb-1">Spending</p>
        <span className="font-display text-3xl font-semibold tabular-nums text-accent-red">
      ...
      {/* Savings rate stat */}
      <div className="flex-1 min-w-[200px] pl-6 flex flex-wrap items-center gap-x-6 gap-y-2">
