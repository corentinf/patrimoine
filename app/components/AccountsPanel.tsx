              ...
              >
                ...
                <div className="flex items-center gap-1 shrink-0">
                  ...
                  <button
                    onClick={() => onEdit(a)}
                    title="Edit"
                    className="w-4 h-4 flex items-center justify-center text-ink-300 hover:text-ink-600 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity ml-0.5"
                  >
